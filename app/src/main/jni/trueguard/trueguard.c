...
// JNI TrueguardService

JNIEXPORT jlong JNICALL
Java_me_aravi_firewall_TrueguardService_jni_1init(
...
Java_me_aravi_firewall_TrueguardService_jni_1start(
...
JNIEXPORT void JNICALL
Java_me_aravi_firewall_TrueguardService_jni_1run(
...
JNIEXPORT void JNICALL
Java_me_aravi_firewall_TrueguardService_jni_1stop(
...
JNIEXPORT void JNICALL
Java_me_aravi_firewall_TrueguardService_jni_1clear(
        JNIEnv *env, jobject instance, jlong context) {
    struct context *ctx = (struct context *) context;
    clear(ctx);
}
...
Java_me_aravi_firewall_TrueguardService_jni_1get_1mtu(JNIEnv *env, jobject instance) {
    return get_mtu();
}

JNIEXPORT jintArray JNICALL
Java_me_aravi_firewall_TrueguardService_jni_1get_1stats(
        JNIEnv *env, jobject instance, jlong context) {
    struct context *ctx = (struct context *) context;
...
JNIEXPORT void JNICALL
Java_me_aravi_firewall_TrueguardService_jni_1pcap(
...
JNIEXPORT void JNICALL
Java_me_aravi_firewall_TrueguardService_jni_1socks5(JNIEnv *env, jobject instance, jstring addr_,
...
JNIEXPORT void JNICALL
Java_me_aravi_firewall_TrueguardService_jni_1done(
        JNIEnv *env, jobject instance, jlong context) {
    struct context *ctx = (struct context *) context;
...
Java_me_aravi_firewall_MainActivity_jni_1getprop(JNIEnv *env, jclass type, jstring name_) {
    const char *name = (*env)->GetStringUTFChars(env, name_, 0);
    ng_add_alloc(name, "name");
...
Java_me_aravi_firewall_MainActivity_is_1numeric_1address(JNIEnv *env, jclass type, jstring ip_) {
    jboolean numeric = 0;
...
void log_packet(const struct arguments *args, jobject jpacket) {
    ...
    const char *signature = "(Lme/aravi/firewall/beans/Packet;)V";
...
void dns_resolved(const struct arguments *args,
    ...
    const char *signature = "(Lme/aravi/firewall/beans/ResourceRecord;)V";
...
void account_usage(const struct arguments *args, jint version, jint protocol,
    ...
    const char *signature = "(Lme/aravi/firewall/beans/Usage;)V";
...
JNIEXPORT void JNICALL
Java_me_aravi_firewall_MainActivity_dump_1memory_1profile(JNIEnv *env, jclass type) {
#ifdef PROFILE_MEMORY
